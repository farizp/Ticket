            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-10 mx-auto">
                        <form class="custom-form ticket-form mb-5 mb-lg-0" action="{{ route('post-ticket') }}"
                            method="POST">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <input type="tel" class="form-control" name="phone" id="phone"
                                            placeholder="0857-4565-7890" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}"
                                            required="">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-check form-control">
                                            <input class="form-check-input" type="radio" name="ticket" id="ticket"
                                                placeholder="Eary bird" value="Early bird 120">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-check form-check-radio form-control">
                                            <input class="form-check-input" type="radio" name="ticket"
                                                id="ticket" placeholder="Standard" value="Standard 240">
